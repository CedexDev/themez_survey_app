...
<div class="reg-cont">
    <div class="reg-mid">
        ...
        <div class="reg-head">
            ...
            <p>{{ __("Create an account now – it's absolutely free") }}
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                <input type="name" class="fs-xs rounded-3 form-control @error('name') is-invalid @enderror"
            ...
            <div class="form-group">
                <input type="email" class="fs-xs rounded-3 form-control @error('email') is-invalid @enderror"
            ...
            <div class="form-group">
                <input type="password" class="fs-xs rounded-3 form-control @error('password') is-invalid @enderror"
            ...
            <div class="form-group text-center">
                <button type="submit" class="button-submit">{{ __('Create Account') }}</button>
            </div>
        </form>

        <p class="mb-0 mt-5 fs-xs text-center">
            <small>
                <span class="text-white-60">Already a member?</span> <a href="{{ route('login') }}"
                    class="text-center text-white">{{ __("Sign in") }}</a>
            </small>
        </p>
    </div>
</div>
