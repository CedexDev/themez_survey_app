...
<head>
    ...
    <link href="{{ asset('company/css/company.css?917778999') }}" rel="stylesheet" type="text/css">
...
<body class="@if (Route::is('company.billing.plans')) plans-view @endif    @if (Route::is('company.surveys.edit', 'company.surveys.share.show', 'company.surveys.result.index', 'company.surveys.design.edit', 'company.surveys.questions.index'))
           bg-black
        @endif $view_name">
    ...
    <div class="wrapper">
        ...
        @if (!Route::is('company.surveys.edit', 'company.surveys.share.show', 'company.surveys.result.index', 'company.surveys.design.edit', 'company.surveys.questions.index', 'company.surveys.index'))
