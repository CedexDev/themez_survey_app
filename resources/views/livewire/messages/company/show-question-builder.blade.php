<div class="card-body pl-0 pr-0">
    ...
    <div class="dropdown">
        <button class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">Add Question</button>
            ...
            <div class="question-tab question-left">
                <ul id="myTab" role="tablist">
                    ...
                    <li wire:click="showQuestion('{{ $question->id }}')"
                        class="@if($activeQuestion && $question->id == $activeQuestion->id) active @endif si-quadron">
                        {{ $question->text }}</li>
                    @endforeach
                </ul>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="question-tab">
                            ...
                            <div class="col-md-12 px-0 mb-3 mt-1">
                                <textarea class="form-control col-md-12 mx-auto" rows="1"
                            ...
                            <div class="col-md-12 px-0 mb-3 mt-1">
                                <textarea class="form-control col-md-12 mx-auto" rows="1"
                                    wire:model.defer="activeQuestion.paragraph"></textarea>
                            </div>
                            ...
                            <div class="col-md-12 px-0 mb-3 mt-1">
                                ...
                                <div class="list-card-image"><img class="item-img-question mb-3"
                                        src="{{url('/storage/'.$activeQuestion->image) }}"></div>
                                @endif
                            ...
                            <div class="col-md-12 text-left mx-auto pl-0 mb-30">
                                <button class="btn btn-info btn-sm"
                                    wire:click.prevent="addChoice({{ $activeQuestion->id }})"><i
                                        class="fas fa-plus mr-2"></i>{{ __('Add Choice') }}</button>
                            </div>
                            @endif
                            @endif
